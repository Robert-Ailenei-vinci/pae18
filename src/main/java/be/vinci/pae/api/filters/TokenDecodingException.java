 ...
 * Instances of this exception typically indicate issues such as invalid or expired tokens, or other
 * problems encountered during the decoding process.
 */
public class TokenDecodingException extends WebApplicationException {
  ...
  /**
   * Constructs a new TokenDecodingException with the specified cause and a detail message that is
   * the cause's string representation.
   *
