...
/**
 * This class provides utility methods for loading and retrieving properties from a configuration file.
 */
public class Config {
   ...
   *
   * @param key The key of the property to retrieve.
   * @return The integer value of the property, or 0 if the key is not found or cannot be parsed as an integer.
   */
   ...
   *
   * @param key The key of the property to retrieve.
   * @return The boolean value of the property, or false if the key is not found or cannot be parsed as a boolean.
   */
